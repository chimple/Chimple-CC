define([
  ...
  function(Phaser) {
    ...
    LevelMenuState.prototype = Object.create(Phaser.State.prototype);
    LevelMenuState.prototype.contructor = LevelMenuState;


    LevelMenuState.prototype.preload = function() {

      //Load Data to construct Levels
      this.load.atlas('base-level', 'assets/level-info/match-shape/images/without_color.png', 'assets/level-info/match-shape/images/without_color.json');
      this.load.atlas('level-object', 'assets/level-info/match-shape/images/object.png', 'assets/level-info/match-shape/images/object.json');
      this.load.atlas('level-color', 'assets/level-info/match-shape/images/color.png', 'assets/level-info/match-shape/images/color.json');
      this.load.image('levelMenuBackGround', 'assets/level-info/match-shape/images/level_menu_background.png');
      this.load.atlas('control-buttons', 'assets/game-misc/controls/extra_buttons.png', 'assets/game-misc/controls/extra_buttons.json');

    };

    LevelMenuState.prototype.create = function() {
    ...
    LevelMenuState.prototype.buildShapewhichLevel = function() {
      this.createLevels();
      this.animateLevels();
    };

    LevelMenuState.prototype.createLevels = function() {
    ...
    LevelMenuState.prototype.constructLevelGrid = function(rows, columns, levelLocks, levelScores) {
    ...
    LevelMenuState.prototype.consturctLevelIconGroup = function(iCol, iRow, columns, rows, level, isLocked, howManyStars) {
      // create new group
    ...
    LevelMenuState.prototype.animateLevels = function() {
    ...
    LevelMenuState.prototype.onSpriteDown = function(sprite, pointer) {
      ...
      LevelMenuState.prototype.scaleGame = function() {
      ...
      LevelMenuState.prototype.gameResized = function(width, height) {
